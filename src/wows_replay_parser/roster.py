...
def build_roster(
    ...
    discovered during packet decoding. Derives team_id from
    the relation field (0=self/1=ally → team 0, 2=enemy → team 1).
    """
    ...
    for vehicle in vehicles:
        ...
        # Derive team_id from relation: self(0) and ally(1) → team 0,
        # enemy(2) → team 1
        ...
        # Try to match entity_id from tracked vehicles
